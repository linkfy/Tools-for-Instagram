async function getFollowActivityFromHourToNow(ig, time = "00:00") {
    ...
    let results = await ig.db.get('follows').filter(follow => follow.created_at > startingTime).value();
    return results.length;
}

module.exports = getFollowActivityFromHourToNow;