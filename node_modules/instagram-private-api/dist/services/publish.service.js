...
class PublishService extends repository_1.Repository {
    ...
    async video(options) {
        ...
        return await Bluebird.try(() => this.client.media.configureVideo(configureOptions)).catch(errors_1.IgResponseError, error => {
    ...
    async uploadAndConfigureStoryVideo(options, configureOptions) {
        ...
        return await Bluebird.try(() => this.client.media.configureToStoryVideo(Object.assign({ upload_id: uploadId, length: videoInfo.duration / 1000.0, width: videoInfo.width, height: videoInfo.height }, configureOptions))).catch(errors_1.IgResponseError, error => {
            throw new errors_1.IgConfigureVideoError(error.response, videoInfo);
        });
    }
    async story(options) {
